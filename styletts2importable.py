...
config = yaml.safe_load(open("/app/Models/StyleTTS2-LibriTTS/LibriTTS/config.yml"))
...
params_whole = torch.load("/app/Models/StyleTTS2-LibriTTS/LibriTTS/epochs_2nd_00020.pth", map_location='cpu')
